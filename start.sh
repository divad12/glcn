...
make -C mybot && java -jar tools/PlayGame2.jar maps/map39.txt 1000 1000 log.txt "java -jar example_bots/BullyBot.jar" "mybot/MyBot debug" | java -jar tools/ShowGame.jar
